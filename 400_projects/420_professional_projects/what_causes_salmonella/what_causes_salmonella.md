...
- [ ] #tasks Complete langchain course #planned
...
- [ ] #task Make slides for half day meeting
- [ ] #task create an agent that can *reason* and not just use SQL queries. #ongoing
- [ ] #task Change the `requirements.txt` file so that the requirements are platform specific. 
- [ ] #task Use other models 
