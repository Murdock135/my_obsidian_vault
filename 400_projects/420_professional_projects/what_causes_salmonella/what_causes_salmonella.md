...
- [ ] #task Fill up 6 month plan form #planned
- [x] #task Fill up Data sources form #planned ✅ 2025-01-15
- [ ] #task Log transformations in preprocessing files #planned
...
- [ ] #task Discuss where to store data #ongoing
- [ ] #task Find and Read Review papers on agentic systems #planned 
# Ramblings
